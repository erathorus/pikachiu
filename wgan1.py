...
import utils
from models.discriminator import discriminator1
from models.generator import generator1
...
if __name__ == '__main__':
    ...
    with tf.Session(config=config) as session:
        ...
        with tf.device(DEVICE):
            ...
            fake_data = generator1(BATCH_SIZE)

            disc_real = discriminator1(real_data)
            disc_fake = discriminator1(fake_data)
            ...
            gradients = tf.gradients(discriminator1(interpolates), [interpolates])[0]
        ...
        fixed_noise_sample = generator1(BATCH_SIZE, fixed_noise)
